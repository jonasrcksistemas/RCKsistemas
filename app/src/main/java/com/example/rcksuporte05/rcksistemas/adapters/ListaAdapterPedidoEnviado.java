...
public class ListaAdapterPedidoEnviado extends ArrayAdapter<WebPedido> {

    private Context context;
    private List<WebPedido> lista;
    private Date dataHora;

    public ListaAdapterPedidoEnviado(Context context, List<WebPedido> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txtIdPedido.setText(itemPosicao.getId_web_pedido_servidor());
